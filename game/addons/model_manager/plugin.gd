...
const _main_panel : PackedScene = preload("res://addons/model_manager/panels/MainPanel.tscn")
const _script_icon : Texture = preload("res://addons/model_manager/icons/icon_multi_line.png")
